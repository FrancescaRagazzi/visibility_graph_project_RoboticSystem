...
class Cart2DRobot(RoboticSystem):
    ...
    def __init__(self):
        ...
        # radius = 15cm
        # friction = 0.8
        self.cart = Cart2D(1, 0.15, 0.8, 0.8) #massa 1 kg raggio 15 cm e attrito per alfa e beta 

    def run(self):  #controllare in modo flessibile il moto
        #quando si mette F = 0 c'è comunque una componente di inerzia che si deve esaurire per cui continuerà un po ad andare dritto
